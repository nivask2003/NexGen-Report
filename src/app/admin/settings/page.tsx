                ...
                <section className="bg-white p-8 rounded-2xl border border-border shadow-sm space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" className="w-full bg-gray-50 border border-border rounded-xl py-3 px-4 text-sm font-bold" defaultValue="Uplike News" />
                        </div>
                        <div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea rows={3} className="w-full bg-gray-50 border border-border rounded-xl py-3 px-4 text-sm" defaultValue="Stay updated with the latest news on technology, business, lifestyle, and more at Uplike News." />
                        </div>
                    </div>
                </section>
